...
<div class="col-12 col-md-9 bg-white  border rounded-3 p-0 overflow-hidden" id="mainPanel" style="height: 30rem">
    <h3 class="text-center bg-primary text-white p-0 m-0 shadow">My Team</h3>
        ...
        <h6 class="border d-flex justify-content-center ">
            <form action="" class="d-flex">
                <div class="form-check mx-1 mx-md-5">
                    <input class="form-check-input" type="radio" id="CheckAll" name="Teamtype" value="All">
                ...
                <div class="form-check mx-1 mx-md-5">
                    <input class="form-check-input" type="radio" id="CheckJoined" name="Teamtype" value="Joined">
...
$(document).ready(function() {
    $("#CheckAll").click(
        function() {
            var teamType = $("#CheckAll").val();
            //alert(teamname);

            $.ajax({
                type: "POST",
                url: "my-team-list-proc.php",
                data: {
                    teamType: teamType
                },
                //dataType: "json",
